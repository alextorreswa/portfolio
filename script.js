...
const experiences = [["Data Scientist Intern","Dallas, TX","05/2022 - Present","• Use of real world data sets to extract data in unstructured format and store in structured format. (Python, JSON, GitHub, Regular Expressions - RegEx) <br/>• Create, Update and Review functions for new versions and  implementations."],
